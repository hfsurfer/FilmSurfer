...
public class TopRatedMovies  extends AppCompatActivity implements RecyclerViewAdapter.OnMovieListener {
    //vars
    private TextView MovieExample;
    private static final String TAG = "TopRatedMovies";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<MoviesList> call = GetMoviesApi.getTopRatedMovies();
        ...
        call.enqueue(new Callback<MoviesList>() {
            ...
            public void onResponse(Call<MoviesList> call, Response<MoviesList> response) {
                if (!response.isSuccessful()) {
                    Toast.makeText(TopRatedMovies.this, "Error fetching the movies!!",
            ...
            public void onFailure(Call<MoviesList> call, Throwable t) {
                ...
                Toast.makeText(TopRatedMovies.this, "Error fetching the data!! Check your internet Connection!!",
                        Toast.LENGTH_LONG).show();
                loadCurrrentMovies();
    ...
    protected void onPause() {
        ...
        savedDataEditor.putString("currentMovies_TopRated", jsonString);
    ...
    public void OnMovieClick(int position) {
        ...
        //Toast.makeText(TopRatedMovies.this, "onMovieClick: clicked:" + position,
        //       Toast.LENGTH_LONG).show();
        ...
        intent.putExtra("type",1);//Type 1 -> Top Rated Movies
